function nextSong() {
    ...
    document.getElementById("BGsong").src = "/static/music/bg/" + (songs[Math.round(Math.random() * songs.length)] || songs[0]);
...
function playSound(name) {
    document.getElementById("soundSrc").src = "/static/music/sounds/" + name + ".mp3";
