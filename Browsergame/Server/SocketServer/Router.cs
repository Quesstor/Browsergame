...
namespace Browsergame.Server.SocketServer {
    class socketMessage {
        private static string[] routableEvents = { "SetOffer", "OrderProduction", "StartBuildingUpgrade", "StartAtack", "UpdateCityInfo", "IncreasePopulation" , "LoadItemOnUnit" , "MoveUnit"};
