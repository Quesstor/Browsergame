    ...
    class setOffer : Event {
        ...
        public override bool conditions() {
            ...
            if (newQuant > 0 && planetQuantWithSellOffers < newQuant) {
                Logger.log(44, Category.Event, Severity.Warn, string.Format("setOffer rejected: planet only has {0} < {1} quant", planet.items[type].quant, newQuant));
                return false;
            }
            return true;
        }
        ...
        public override void execute() {
            ...
            planet.offers[type].price = newQuant == 0 ? 0 : price;
        }
    }
}
